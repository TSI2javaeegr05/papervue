    ...
    <div class="ui item column">
        <div class="content">
            ...
            <div class="row border-top-paperviu-sky"
                 style="padding-top: 10px; padding-right: 16px; padding-left: 16px; background-color: #e8eef5">
                ...
                <div class="ui secondary borderless pointing relaxed menu" style="border: 0; padding: 0; margin: 0">
                    <div class="ui item" style="margin: 0; padding-left: 0">
            ...
            <div :id="id + 'popup'" class="ui transition hidden basic flowing popup paperviu-e8"
