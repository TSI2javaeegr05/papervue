        ...
        <div id="listado" class="ui stackable grid" style="margin: 0">
                        ...
                        <infinite-loading ref="infiniteLoading"
                            ...
                            <div slot="no-more">
                                <h3 class="ui header text-paperviu-d7" style="opacity: 0.6"><i
                                        class="search icon text-paperviu-sky"></i>No hay m&aacute;s empresas.
                                </h3>
                            </div>
                            <div slot="no-results">
                                <h3 class="ui header text-paperviu-d7" style="opacity: 0.6"><i
                                        class="search icon text-paperviu-sky"></i>No hay empresas que mostrar.
                                </h3>
                            </div>
                        </infinite-loading>
                    </div>
            ...
            <div class="twelve wide column" style="padding: 0; margin: 0">
                ...
                <div v-show="empresa.nombre !== ''" class="row" style="padding-left: 20px">
                    <div class="ui toggle checkbox">
                        ...
                        <label class="text-paperviu-d7"
                            ...
                            {{empresa.estado ? 'Empresa habilitada' : 'Empresa deshabilitada'}}
                        </label>
                    </div>
                </div>
                <div class="row" style="padding: 25px">
                    ...
                    <h3 v-show="empresa.emailPago !== ''" class="ui header text-paperviu-d7" style="margin-top: 16px;">
                        <i
                                class="paypal text-paperviu-sky icon"></i>{{empresa.emailPago}}</h3>
                </div>
            </div>
        </div>
            ...
            <div class="ui text container paperviu-e8 border-left-paperviu-sky">
                <div class="row" style="padding: 30px">
                    <h3 class="ui left ribbon label big inverted paperviu-dark"
                        style="margin-left: -15px; padding-top: 7px; padding-bottom: 7px">
                ...
                <div class="row" style="padding: 30px">
                    <h3 class="ui left ribbon label big inverted paperviu-dark"
                        style="width: auto;margin-left: -15px; padding-top: 7px; padding-bottom: 7px">
                ...
                <div class="ui basic segment"
                    ...
                    <div class="ui toggle checkbox"
                        ...
                        <label class="ui header text-paperviu-dark"
                               style="margin: 0px">
                            {{ estadoEmpresa ? 'Habilitada' : 'Deshabilitada' }}
                        </label>
                    </div>
                    ...
                    <div class="ui fluid labeled input"
                         style="margin-top: 16px; padding-left: 16px; padding-right: 16px">
                        <div class="ui basic right pointing label">Sitio web</div>
                ...
                <div class="row" style="padding: 30px">
                    <h3 class="ui left ribbon label big inverted paperviu-dark"
                        style="width: auto;margin-left: -15px;padding-top: 7px; padding-bottom: 7px">
                        <i class="paypal icon"></i>Informaci&oacute;n de PayPal</h3>
                </div>
                <div class="ui basic segment" style="padding-top: 0">
                    <div class="ui fluid labeled input"
                         style="padding-left: 16px; padding-right: 16px">
                        <div class="ui basic right pointing label">Email</div>
                        <input v-model="emailPago" type="text"
                               placeholder="Ingrese email asociado a la cuenta de PayPal de la empresa...">
                    </div>
                </div>
                <div class="row" style="padding: 30px">
                    <h3 class="ui left ribbon label big inverted paperviu-dark"
                ...
                <div class="ui bottom fixed secondary menu">
                    <div class="ui basic center aligned segment border-bottom-paperviu-sky"
                        ...
                        <button @click="crearEmpresa"
                                class="ui big compact button paperviu-sky hover-paperviu-63 text-paperviu-e8"><i
...
<script>
    ...
    export default {
        ...
        computed: {
            altaEmpresaURL() {
                return this.$store.state.baseUrl + 'empresas?nombre=' + this.nombreEmpresa + "&link=" + this.linkEmpresa + "&username=" + this.usernameEmpresa + "&password=" + this.passwordEmpresa + "&email=" + this.emailEmpresa + "&estado=" + this.estadoEmpresa + "&emailPago=" + this.emailPago;
            },
            guardarImagenURL() {
        ...
        methods: {
            ...
            guardarImagen() {
                if (this.imagen !== Object) {
                    this.mostrarInfo("Guardando imagen...");
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data === true || data === "true") {
                                    _this.mostrarExito("Imagen guardada!");
                                    _this.nombreEmpresa = '';
                                ...
                                } else _this.mostrarError("No se pudo guardar imagen. Por favor vuelva a intentar");
                            },
                            error: function (xhr, status, errorData) {
                                _this.mostrarError("No se pudo guardar imagen. Por favor vuelva a intentar");
                            }
                        });
                ...
                if (this.empresaActual !== "") {
                    ...
                    $.get(this.getEmpresaURL, function (response) {
                        if (response !== undefined) {
                            ...
                            _this.empresa.emailPago = response.emailPago || '';
            ...
            crearEmpresa() {
                if (this.nombreEmpresa !== '' && this.emailEmpresa !== '') {
                    this.mostrarInfo("Creando empresa...");
                    var _this = this;
                    $.post(this.altaEmpresaURL, function (response) {
                        if (response === true || response === "true") {
                            _this.mostrarExito("Empresa creada!");
                        ...
                        } else _this.mostrarError("No se pudo crear la empresa");
                    }).fail(function () {
                        _this.mostrarError("No se pudo enviar solicitud. Por favor vuelve a intentar...");
                    });
                } else _this.mostrarAlerta("Debes ingresar el nombre, y email de la empresa!");
            },
            cambiarEstado() {
                ...
                } else _this.mostrarAlerta("Debes seleccionar una empresa!");
            },
            getImagen() {
