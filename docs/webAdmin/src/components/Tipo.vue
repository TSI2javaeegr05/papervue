                ...
                <div class="row" style="padding: 16px">
                    <div class="ui toggle checkbox" style="margin: 0; padding: 5px">
                        ...
                        <label class="ui header text-paperviu-d7"
                            ...
                            {{enVivo?'Streaming en vivo' : 'No utilizado para Streaming en vivo' }}
                        </label>
                    </div>
                        ...
                        <infinite-loading ref="infiniteLoading"
                            ...
                            <div slot="no-more">
                                <h3 class="ui header text-paperviu-d7" style="opacity: 0.6"><i
                                        class="search icon text-paperviu-sky"></i>No hay m&aacute;s tipos.
                                </h3>
                            </div>
                            <div slot="no-results">
                                <h3 class="ui header text-paperviu-d7" style="opacity: 0.6"><i
                                        class="search icon text-paperviu-sky"></i>No hay tipos que mostrar.
                                </h3>
                            </div>
                        </infinite-loading>
                    </div>
