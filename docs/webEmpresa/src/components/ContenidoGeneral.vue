            ...
            <div class="ui text container" v-show="!loading">
                ...
                <div class="ui fluid labeled small input" style="margin-top: 16px">
                    ...
                    <select multiple="" id="categorias" class="ui fluid search dropdown">
                        <template v-for="cat in this.$store.state.categorias">
        ...
        methods: {
            cargarTLS() {
                if (this.contenidoActual !== undefined) {
                    ...
                    if (this.contenidoActual.categorias !== undefined) $('#categorias').dropdown('set selected', this.contenidoActual.categorias);
                    if (this.contenidoActual.directores !== undefined) $('#directores').dropdown('set selected', this.contenidoActual.directores);
                    if (this.contenidoActual.actores !== undefined) $('#actores').dropdown('set selected', this.contenidoActual.actores);
                }
            },
            actualizarContenido() {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response !== undefined) {
                            ...
                            else _this.mostrarErrorActualizar();
                        } else _this.mostrarErrorActualizar();
                    },
                    error: function () {
